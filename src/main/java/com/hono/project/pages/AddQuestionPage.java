...
public class AddQuestionPage extends BaseHonoAutomationPage {
	...
	// @FindBy(xpath = "//textarea[@class='form-control ng-pristine ng-invalid
	// ng-star-inserted ng-touched']")
	// @FindBy(xpath = "//div[@class=\"col-lg-12 pb-3 mb-2\"]")
	...
	public void clickOnQuestion() throws InterruptedException {
		this.highlight(driver,question);
		this.clickOnWebElement(question);
		// this.question.click();
	}
	...
	public void enterAddQuestions(String AddQuestions) {
		this.addQuestions.sendKeys(AddQuestions);
	}
