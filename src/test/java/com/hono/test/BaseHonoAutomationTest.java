...
public class BaseHonoAutomationTest {
	...
	protected String loginURL = "http://uat.finance.slate.ac/";

	private static final Logger logger = Logger.getLogger(BaseHonoAutomationTest.class.getName());
	...
	protected void siteLogin(String siteURL,WebDriver driver) throws Exception {
		logger.debug("Login URL :" + siteURL);

		driver.get(siteURL);

		//this.loginPage.loginToHono(userName, password);
