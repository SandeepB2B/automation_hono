...
public class AddImageQuestionPage extends BaseHonoAutomationPage{
	...
	@FindBy(xpath = "(//span[contains(text(),'Image')])[1]")
	...
	public AddImageQuestionPage(WebDriver driver) {
		super(driver);
	...
	public void uploadImage() throws InterruptedException {
		uploadImage.sendKeys("C:\\B2BNew\\automation-hono\\src\\test\\resources\\data\\Image Question.png");
	}
