...
public class AddVideoQuestionPage extends BaseHonoAutomationPage{
	...
	public AddVideoQuestionPage(WebDriver driver) {
		super(driver);
	...
	public void clickOnVideoButton() {
		this.clickOnWebElement(videobtn);
		
	}
	
	public void uploadVideo() throws InterruptedException {
		uploadVideo.sendKeys("C:\\B2BNew\\automation-hono\\src\\test\\resources\\data\\Video question.mp4");
	}
